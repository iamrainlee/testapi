    ...
    if(played.count('') == 9):
        ...
        for i in range(len(played)):
            if(played[i] == ''):
                ...
                break
    requests.post(f'https://cis2021-arena.herokuapp.com/tic-tac-toe/play/{battleId}',json.dumps(played))
...
def tictactoe():
    ...
    messages = SSEClient(f'https://cis2021-arena.herokuapp.com/tic-tac-toe/start/{battleId}')
